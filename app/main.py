...
from app.routes import auth, users, kaizens, action_plans, dashboards, reparti, uploads, documenti, configurazioni, pillars, cleanup
...
app.include_router(cleanup.router, prefix="/api/cleanup", tags=["🗑️ Cleanup (TEMP)"])
