...
class ActionPlanCreate(BaseModel):
    ...
    parent_type: Optional[Literal["kaizen", "major_kaizen", "pillar", "dashboard", "segnalazione", "standalone"]] = "standalone"
...
class ActionPlanUpdate(BaseModel):
    ...
    # Contesto
    parent_type: Optional[Literal["kaizen", "major_kaizen", "pillar", "dashboard", "segnalazione", "standalone"]] = None
    parent_id: Optional[str] = None
    parent_label: Optional[str] = None
    pillar_id: Optional[str] = None
    dashboard_id: Optional[str] = None
